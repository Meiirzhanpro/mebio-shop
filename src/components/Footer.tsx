      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mt-4">
            <a
              href="https://www.instagram.com/mebio.kz"
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 rounded-lg flex items-center justify-center text-white hover:scale-110 transition-transform duration-200"
              aria-label="Instagram"
            >
              <InstagramIcon />
            </a>
            <a
              href="https://wa.me/77074794753"
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 bg-[#25D366] rounded-lg flex items-center justify-center text-white hover:scale-110 transition-transform duration-200"
              aria-label="WhatsApp"
            >
              <WhatsAppIcon />
            </a>
